<template>
  <form @submit.prevent="submitForm">
    <div class="form-control" :class="{invalid: userNameValidation === 'invalid'}">
      ...
      <p v-if="userNameValidation === 'invalid'">Please type correct user name</p>
    </div>
    ...
    <div class="form-control">
      ...
      <select id="referrer" name="referrer" v-model="referrer">
        <option value="google">Browser</option>
    ...
    <div class="form-control">
      ...
      <label for="confirm-terms">Agree with terms</label>
    </div>
    <div>
...
export default {
  ...
  methods: {
    ...
    resetField() {
      ...
      this.how = null;
      this.confirm = false;
      this.userNameValidation = 'pending';
      this.rating = null;
    ...
    validateInput() {
      if (this.userName === ''){
        ...
        this.userNameValidation = 'correct';
      }
    }
  }
}
